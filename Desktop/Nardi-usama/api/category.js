...
db.collection('category').get().then((data) => {
    data.forEach((categoryData) => {
        ...
        <td><img src="${categoryData.data().categoryImage}" width="40px" /></td>
        <td>${categoryData.data().categoryTitle}</td>
        
        <td><a href="${url}edit-category.html?id=${categoryData.data().categoryId}" class="btn btn-primary"> View </a></td>
